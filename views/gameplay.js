...
export default function gameplay() {
    ...
    let chef = kitchenObjects.topChef;
    let choppingBoards = [
        kitchenObjects.choppingCounter,
        kitchenObjects.choppingCounter2,
        kitchenObjects.choppingCounter3
    ];
    let fryingPans = [kitchenObjects.fryingPan, kitchenObjects.fryingPan2];
...
const buildkitchenObjects = () => {
    ...
    kitchenObjects["mixingBowl1"] = setup('images/counters.png', 3, 4, 7.3, 4.5,
        { x: xStart + 8 * width, y: kitchenObjects["rightSideCounter2"].y }, { x: 1.5, y: 1.5 })
    kitchenObjects["mixingBowl2"] = setup('images/counters.png', 3, 4, 7.3, 4.5,
    ...
    kitchenObjects["jollof"] = setup('images/jollof.png', 0, 0, 1, 1, { x: 100, y: 50 }, { x: .15, y: .15 })    
